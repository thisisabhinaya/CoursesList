...
public class ParentLevelAdapter extends BaseExpandableListAdapter {
    ...
    public ParentLevelAdapter(Context mContext, List<String> mListDataHeader) {
        ...
        for (int i = 0; i < parentCount; i++) {
            ...
            mListData_SecondLevel_Map.put(mListDataHeader.get(i), Arrays.asList(mItemHeaders)); //converting string arr of coding to list
        }
        // THIRD LEVEL
        String[] mItemChildOfChild;
        List<String> listChild;
        mListData_ThirdLevel_Map = new HashMap<>(); //hashmap
